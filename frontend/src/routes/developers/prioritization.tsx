          ...
          <main className="w-full min-w-0 space-y-8 md:flex-1">
            <section style={{ maxWidth: "100%", width: "calc(100vw - 2rem)" }}>
              ...
              <p className="mt-3 max-w-[68ch] text-[14px] leading-relaxed text-zinc-400">
                How we decided what to solve for. Eight candidate themes, scored against
                ConnectWork's own brief - the goal, the existing assets, the platform's position,
                and its risk surface. The build order lives in the{" "}
                <Link
            ...
            >
              ...
              <p className="max-w-[68ch] text-[12px] leading-relaxed text-zinc-500">
                Lower tiers reflect the brief, not the field: multi-agent orchestration reads as
                scope creep against a one-agent task, and cost routing barely touches the stated
                goal.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-1.5 max-w-[68ch] text-[13px] leading-relaxed text-emerald-100/90">
                The rubric ranks cross-source grounding first; deterministic gating is a close
                second and leads the live demo as the rail that makes grounding's actionable
                extension safe to ship. What gets built first is a separate question - that's the{" "}
                <Link
                  to="/developers/roadmap"
